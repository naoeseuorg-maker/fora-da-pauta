export default function Home() {
  ...
  <p>
    O Terceiro Nível é um projeto de observação pública.
  </p>

  <p>
    Transformamos temas complexos em perguntas acessíveis, conectando
    reflexão, participação e circulação de ideias.
  </p>

  <p>
    Alguns assuntos afetam milhões de pessoas, movimentam bilhões ou
    trilhões de reais e, ainda assim, recebem pouca atenção proporcional
    à sua importância.
  </p>
</div>
  ...
  <h2 className="text-3xl md:text-4xl leading-tight font-semibold mb-10">
    O projeto também se constrói com perguntas.
  </h2>
...
Sugira temas, acompanhe conteúdos e participe do projeto.
    </h3>

    <p className="text-zinc-500 leading-relaxed">
      O Terceiro Nível é um projeto aberto à observação pública,
à reflexão e à participação cidadã.
    </p>
  </a>
</section>
